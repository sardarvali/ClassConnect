...
<<<<<<< HEAD
                _assignments.value = NetworkResult.Error(e.message ?: "Failed to load")
=======
                _assignments.value = NetworkResult.Error(
                    e.message ?: context.getString(R.string.error_failed_to_load)
                )
>>>>>>> final
            }
        }
...
=======
                onFailure = {
                    NetworkResult.Error(
                        it.message ?: context.getString(R.string.error_submit_failed)
                    )
                }
>>>>>>> final
            )
...
<<<<<<< HEAD
                _allSubmissions.value = NetworkResult.Error(e.message ?: "Failed to load")
=======
                _allSubmissions.value = NetworkResult.Error(
                    e.message ?: context.getString(R.string.error_failed_to_load)
                )
>>>>>>> final
            }
    ...
    fun gradeSubmission(classId: String, assignmentId: String, studentId: String, grade: Int, feedback: String) {
        ...
        viewModelScope.launch {
            ...
            _gradeResult.value = result.fold(
                onSuccess = { NetworkResult.Success(it) },
                onFailure = { NetworkResult.Error(it.message ?: "Grade failed") }
=======
    fun gradeSubmission(
        classId: String,
        assignmentId: String,
        ...
        _gradeResult.value = NetworkResult.Loading()
        viewModelScope.launch {
            val result = assignmentRepository.gradeSubmission(
                classId,
                assignmentId,
                studentId,
                grade,
            ...
            _gradeResult.value = result.fold(
                ...
                onFailure = {
                    NetworkResult.Error(
                        it.message ?: context.getString(R.string.error_grade_failed)
                    )
                }
>>>>>>> final
            )
...
=======
                onFailure = {
                    NetworkResult.Error(
                        it.message ?: context.getString(R.string.error_delete_failed)
                    )
                }
>>>>>>> final
            )
