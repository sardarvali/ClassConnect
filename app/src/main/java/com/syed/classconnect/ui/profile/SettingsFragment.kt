...
<<<<<<< HEAD
            startActivity(android.content.Intent(requireContext(), com.syed.classconnect.ui.webview.WebViewActivity::class.java).apply {
            ...
            BiometricHelper.BiometricStatus.NONE_ENROLLED -> {
                ...
                binding.switchBiometric.setOnCheckedChangeListener { btn, checked ->
                    if (checked) {
                        btn.isChecked = false
<<<<<<< HEAD
                        Snackbar.make(binding.root, R.string.biometric_none_enrolled, Snackbar.LENGTH_LONG).show()
                    }
                }
            }
=======
                ...
                binding.switchBiometric.setOnCheckedChangeListener { btn, checked ->
                    if (checked) {
                        ...
                        BiometricHelper.authenticate(
                            ...
                            onSuccess = {
<<<<<<< HEAD
                                prefs.edit().putBoolean(Constants.PREF_BIOMETRIC_ENABLED, true).apply()
                                Snackbar.make(binding.root, R.string.biometric_enabled_msg, Snackbar.LENGTH_SHORT).show()
=======
...
>>>>>>> final
                            ...
                            onError = { msg ->
                                ...
                                if (msg.isNotEmpty()) {
<<<<<<< HEAD
                                    Snackbar.make(binding.root, getString(R.string.biometric_auth_error, msg), Snackbar.LENGTH_SHORT).show()
                                }
                            },
                            onFailed = {
                                Toast.makeText(requireContext(), R.string.biometric_auth_failed, Toast.LENGTH_SHORT).show()
=======
