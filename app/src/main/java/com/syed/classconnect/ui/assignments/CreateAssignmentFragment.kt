...
class CreateAssignmentFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCreate.setOnClickListener {
            ...
            val assignment = Assignment(
                ...
                dueDate = Timestamp(dueDate.time),
                totalMarks = marks, createdAt = Timestamp.now()
            )
    ...
    private fun updateDueDateText() {
        binding.btnPickDate.text = android.text.format.DateFormat.format("MMM dd, yyyy hh:mm a", dueDate).toString()
    }
...
class CreateAssignmentFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnAiSuggest.setOnClickListener {
            ...
            val ctx = if (title.isNotBlank() || desc.isNotBlank())
                getString(
                    R.string.ai_suggestion_context_format,
                    title,
                    desc
                ) else getString(R.string.a_new_assignment)
        ...
        binding.btnCreate.text =
            getString(if (existingAssignment != null) R.string.update_assignment else R.string.create_assignment_btn)
        ...
        binding.btnCreate.setOnClickListener {
            ...
            if (title.isEmpty()) {
                binding.tilTitle.error = getString(R.string.required); return@setOnClickListener
            }
    ...
    private fun updateDueDateText() {
        binding.btnPickDate.text = android.text.format.DateFormat.format(
            getString(R.string.date_format_assignment),
            dueDate
        ).toString()
    }
