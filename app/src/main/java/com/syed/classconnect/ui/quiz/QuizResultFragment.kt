...
<<<<<<< HEAD
        fun newInstance(classId: String, quizId: String, studentId: String, score: Int, total: Int) =
=======
        fun newInstance(
            classId: String,
            quizId: String,
...
<<<<<<< HEAD
            parentFragmentManager.setFragmentResult("quiz_result_dismissed", android.os.Bundle())
=======
