...
=======
                ...
                is NetworkResult.Success -> {
                    ...
                    if (result.data.isEmpty()) {
                        binding.layoutEmpty.show(); binding.rvAssignments.hide()
                    } else {
                        binding.layoutEmpty.hide(); binding.rvAssignments.show(); adapter.submitList(
                            result.data
                        )
                    }
                }
