...
<<<<<<< HEAD
    ...
    private fun showAddQuestionDialog() {
        val dialog = AddQuestionDialog { question ->
            questions.add(question)
            binding.tvQuestionCount.text = "${questions.size} question(s) added"
        }
        dialog.show(parentFragmentManager, "add_question")
    }
