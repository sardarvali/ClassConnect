...
fun Fragment.showSuccessSnackbar(message: String) {
    ...
    snackbar.view.background = ContextCompat.getDrawable(requireContext(), R.drawable.bg_snackbar_success)
...
fun Fragment.showErrorSnackbar(message: String) {
    ...
    snackbar.view.background = ContextCompat.getDrawable(requireContext(), R.drawable.bg_snackbar_error)
    snackbar.show()
}
...
fun View.shakeAnimation() {
    ObjectAnimator.ofFloat(this, "rotation",
        0f, -15f, 15f, -10f, 10f, -5f, 5f, 0f).apply {
        duration = 600
...
fun MaterialCardView.pulseElevation(elevated: Boolean) {
    ObjectAnimator.ofFloat(this, "cardElevation",
