...
class QuizAdapter(
    ...
    inner class ViewHolder(private val b: ItemQuizBinding) : RecyclerView.ViewHolder(b.root) {
        fun bind(item: Quiz) {
            ...
            b.btnStudentAction.visibility = if (!isTeacherMode && item.published) android.view.View.VISIBLE else android.view.View.GONE
            ...
            b.root.alpha = 0f
            b.root.animate().alpha(1f).setDuration(300).setStartDelay(bindingAdapterPosition * 40L).start()
        }
