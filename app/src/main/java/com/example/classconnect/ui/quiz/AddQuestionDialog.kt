...
class AddQuestionDialog(private val onAdd: (QuizQuestion) -> Unit) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return AlertDialog.Builder(requireContext())
            ...
            .setPositiveButton(if (currentQuestion == null) "Add" else "Save", null) // Set null here
    ...
    override fun onResume() {
        ...
        dialog?.getButton(AlertDialog.BUTTON_POSITIVE)?.setOnClickListener {
            ...
            val finalCorrect = if (validOptions.isNotEmpty()) rawCorrect.coerceAtMost(validOptions.lastIndex) else 0
            ...
            if (validOptions.size < 2) {
                com.google.android.material.snackbar.Snackbar.make(
                    binding.root, "At least 2 options required", com.google.android.material.snackbar.Snackbar.LENGTH_SHORT
                ).show()
                return@setOnClickListener
            }
