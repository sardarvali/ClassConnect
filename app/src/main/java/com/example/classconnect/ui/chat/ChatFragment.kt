...
class ChatFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val inputBottomMargin = (binding.inputLayout.layoutParams as ViewGroup.MarginLayoutParams).bottomMargin
        val fabBottomMargin = (binding.fabScrollDown.layoutParams as ViewGroup.MarginLayoutParams).bottomMargin
        ViewCompat.setOnApplyWindowInsetsListener(binding.root) { _, insets ->
            ...
            binding.inputLayout.updateLayoutParams<ViewGroup.MarginLayoutParams> {
                bottomMargin = inputBottomMargin + bottomInset
            }
