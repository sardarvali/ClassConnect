...
class LessonPlannerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val fabBottomMargin = (binding.fabUsePlan.layoutParams as ViewGroup.MarginLayoutParams).bottomMargin
        ...
        binding.fabUsePlan.setOnClickListener {
            ...
            AIActionsSheet.newInstance(lastGeneratedPlan, lastTopic, AIActionsSheet.MODE_LESSON_PLAN)
